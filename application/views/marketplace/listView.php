...
<!--Advanced Searchbar ends HERE-->
<!--
<div id="advertiestment">
	<div class="container">
		<div class="col-md-12">
			<center>
				
						<div class="advertiestmentBack">
							<section class="slider">
								<div id="slider" class="flexslider">
										  <ul class="slides">
											<li>
												<img src="<?php //echo BASEURL;?>public/images/advertiestment/advertising.jpg" alt="" style="width:100%;max-width:400px;" />
											</li>
											<li>
												<img src="<?php //echo BASEURL;?>public/images/advertiestment/advertising4.jpg" alt="" style="width:100%;max-width:400px;" />
											</li>
											<li>
												<img src="<?php// echo BASEURL;?>public/images/advertiestment/advertising3.jpg" alt="" style="width:100%;max-width:400px;" />
											</li>
											<li>
												<img src="<?php //echo BASEURL;?>public/images/advertiestment/advertising4.jpg" alt="" style="width:100%;max-width:400px;" />
											</li>
...
<div class="content">
	<div class="container">
		<div class="row">
			<!--
			<div class="col-md-2 col-xs-12 cdRightPane" id="allCategories">
				<div style="margin:5px;font-weight:bold;font-size:13px;">This Another div for advertising</div>				
			</div>
			-->
