...
<div class="container">
	<div class="row">
		<div class="col-md-12">
			<div class="bg-danger" style="margin:50px 10px;padding:30px 40px;border-radius:5px;">Password Recovery email has been sent ! 
										<br />
										<br />
										Check your email and 
										<strong>click on the Activation Link to Activate your account </strong>
			</div>
		</div>
	</div>
</div>
