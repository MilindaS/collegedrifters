...
<div class="container">
	<div class="row">
		<div class="col-md-12">
			<div class="bg-danger" style="margin:50px 10px;padding:30px 40px;border-radius:5px;">
										<strong>Your Email is already exists. Please login  <a href="<?php echo BASEURL;?>login/loginView">here</a></strong>
			</div>
		</div>
	</div>
</div>
